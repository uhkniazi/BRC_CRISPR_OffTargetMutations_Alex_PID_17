...
setwd(gcswd)
n = make.names(paste('CFastqQuality S198 run for Alex CRISPR Cas9 sequencing for off target analysis data id 35'))
lOb$meta.1 = dfSample
lOb$meta.2 = dfFiles
lOb$desc = paste('CFastqQuality S198 run for Alex CRISPR Cas9 sequencing for off target analysis data id 35', date())
...
# df = data.frame(idData=g_did, name=n, type='rds', location='~/Data/MetaData/', comment='CFastqQuality S198 run for Alex CRISPR Cas9 sequencing for off target analysis data id 35')
